...
public class programa extends Funcoes{
	...
	public static void main(String[] args) {
		...
		lista.add(new Produto("G3-1", "Glutamina", 30.00, 10));
		lista.add(new Produto("G3-2", "Vitamina C", 15.00, 10));
		lista.add(new Produto("G3-3", "Regata Cav", 45.00, 10));
		lista.add(new Produto("G3-4", "Tenis Sports", 100.00, 10));
		lista.add(new Produto("G3-5", "Whey Prot", 75.00, 10));
		lista.add(new Produto("G3-6", "Snacks Div", 10.00, 10));
		lista.add(new Produto("G3-7", "C.Legging", 80.00, 10));
		lista.add(new Produto("G3-8", "Camiseta", 25.00, 10));
		lista.add(new Produto("G3-9", "BCAA CAPS", 50.00, 10));
